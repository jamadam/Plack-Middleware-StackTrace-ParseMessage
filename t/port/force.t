...
my $default_app = Plack::Middleware::StackTrace::ParseMessage->wrap($app, no_print_errors => 1);
...
my $force_app = Plack::Middleware::StackTrace::ParseMessage->wrap($app, force => 1, no_print_errors => 1);
